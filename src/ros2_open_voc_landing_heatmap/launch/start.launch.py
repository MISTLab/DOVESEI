...
def generate_launch_description():
   ...
   lander_params = {
        ...
        'gain': (.5, 'Gain used with the error to publish velocity setpoints'),
        'aiming_gain_mult': (.5, 'Multiplier applied to the gain when at AIMING state'),
        'z_speed_landing': (3.0, 'Base value for landing speed'),
        'z_min_speed_landing': (.5, 'Minimal value for landing speed'),
        'z_gain_landing': (.02, 'Gain applied to the landing speed according to the altitude'),
        'z_speed_climbing': (6.0, 'Speed used to climb'),
        'depth_smoothness': (.5, 'Minimal depth smoothness (std)'), # CARLA's values oscillate on flat surfaces
        ...
        'safety_threshold': (.8, 'Used to control the semantic segmentation model'),
        'dist_func_threshold': (.6, 'Threshold used to binarise the segmentation to find the centre of the free areas'),
        ...
        'min_conservative_gain': (.5, 'Minimum value the conservative gain can reach'),
        ...
        'seg_dynamic_threshold': (.10, 'Minimum amount of area good for landing as the segmentation will decrease the threshold until it reaches it (0.0 disables it)'),
        'aiming_descending_mult': (.5, 'Multiplier (in relation to landing speed) for the AIMING state descending speed'),
